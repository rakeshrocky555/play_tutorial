...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """example1""", """controllers.HomeController.exampleURL()"""),
    Nil
  ...
  // @LINE:16
  private[this] lazy val controllers_HomeController_exampleURL4_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("example1")))
  )
  private[this] lazy val controllers_HomeController_exampleURL4_invoker = createInvoker(
    HomeController_0.exampleURL(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "exampleURL",
      Nil,
      "GET",
      this.prefix + """example1""",
      """ below are the example URIs""",
      Seq()
    )
  )
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:16
    case controllers_HomeController_exampleURL4_route(params@_) =>
      call { 
        controllers_HomeController_exampleURL4_invoker.call(HomeController_0.exampleURL())
      }
  }
}
